...
export function updateTranscription(id: string, type: DocumentType, value: TranscriptionValue) { const valid = validateTranscription(type, value); transcriptionStore.replace(id, valid); }
