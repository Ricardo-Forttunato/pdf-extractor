...
export interface HoleriteField { code: string; label: string; reference: string; value: string; }
export interface HoleriteBase { label: string; value: string; }
export interface HoleritePage { page: number; year: string; month: string; fields: HoleriteField[]; bases: HoleriteBase[]; }
...
export type GetTranscriptionResponse = { id: string; tipo: DocumentType; status: "processando"; erro: null; value: null } | { id: string; tipo: DocumentType; status: "concluido"; erro: null; value: TranscriptionValue } | { id: string; tipo: DocumentType; status: "erro"; erro: string; value: null };
